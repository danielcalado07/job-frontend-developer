...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <div className="bg-gray-900 shadow-md rounded-lg p-4 w-full max-w-2xl">
        <div className="flex items-center mb-4 bg-gray-500 p-2 rounded-lg">
          <img
            src={avatarBot.src}
            alt="Chat Bot Icon"
        ...
        <div id="chat-box" className="bg-gray-800 p-4 rounded-lg overflow-y-auto flex flex-col gap-2 h-[50vh] screen">
          ...
          <div id="messages_container-user" className="flex flex-row gap-2 mt-2 justify-end">
            ...
            <img src={avatarUser.src} alt="User Avatar" className="w-8 h-8 rounded-full mb-2" />
          </div>
        </div>
